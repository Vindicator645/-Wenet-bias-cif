...
def main():
    ...
    train_dataset = Dataset_s2c(args.data_type, args.train_data, symbol_table,syl_table,
                            train_conf, args.bpe_model, non_lang_syms, True)
    cv_dataset = Dataset_s2c(args.data_type,
                         args.cv_data,
                         symbol_table,
                         syl_table,
                         cv_conf,
    ...
    syl_size = len(syl_table)

    # Save configs to model_dir/train.yaml for inference and export
    configs['input_dim'] = (vocab_size, syl_size)
